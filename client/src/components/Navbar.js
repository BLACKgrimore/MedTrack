  ...
  return (
    <div>
            ...
            <ul className="flex flex-row items-baseline gap-[5vh]">
              ...
              >
                ...
                {dropdownOpenServices && (
                  <div className="absolute bg-pink-300 top-5 left-0 mt-1 w-48 bg-lightBlue shadow-lg p-6 transition duration-300 ease-in-out z-20">
                    <ul>
              ...
              >
                ...
                {dropdownOpenAbout && (
                  <div className="absolute bg-pink-300 top-5 left-0 mt-1 w-36 bg-lightBlue shadow-lg p-6 transition duration-300 ease-in-out z-30">
                    <ul>
                      <li className="hover:text-darkBlue">
              ...
              <li className="hover:text-darkBlue hover:underline"><Link href="/vendorregister">Register as Vendor</Link></li>
              <li className="hover:text-darkBlue hover:underline"><Link href="/signup">Register as Store</Link></li>
            </ul>
          </div>
      ...
      <div className="top-[47vh] fixed z-20 right-2 bg-green-300 rounded-full h-16 w-16 flex justify-center items-center">
        <Link href="https://wa.me/+919389247597">
      ...
      {menuOpen && (
        <div className="bg-pink-300 py-2 z-10 text-black fixed w-full top-14 left-0 h-fit flex flex-col items-center justify-center lg:hidden transition duration-300 ease-in-out" ref={menuRef}>
          <ul className="flex flex-col text-justify gap-4">
            ...
            <li className="relative" ref={dropdownServicesRef}>
              ...
              {dropdownOpenServices && (
                <div className="absolute bg-pink-300 top-full p-10 mr-[20vw] md:w-36 xsm:w-[38vw] bg-lightBlue shadow-lg md:p-4 xsm:p-3 transition duration-300 ease-in-out z-20">
              ...
              {dropdownOpenAbout && (
                <div className="absolute bg-pink-300 top-full p-10 mr-[20vw] md:w-36 xsm:w-[38vw] bg-lightBlue shadow-lg md:p-4 xsm:p-3 transition duration-300 ease-in-out z-20">
                  <ul>
                    ...
                    <li className="hover:text-darkBlue">
                      <Link href="/teams" onClick={closeMenu}>Our Team</Link>
                    </li>
                    <li className="hover:text-darkBlue">
            ...
            <li className="hover:text-darkBlue hover:underline"><Link href="/vendorregister" onClick={closeMenu}>Register as Vendor</Link></li>
