    ...
    <section className="h-fit py-16 p-3 px-10 bg-veryLightPink flex flex-col space-y-14">
      ...
      <div className="flex md:flex-row justify-between self-center
        ...
        <div className="md:max-w-[30%] space-y-2">
            <img loading="lazy" src='/medtrack/pic4.jpeg' className="rounded-2xl sm:w-[32rem] sm:h-[20rem]" alt="Patna Pharmacy Services"></img>
        ...
        {/* Location 2 */}
        <div className="md:max-w-[30%] space-y-2">
            <img loading="lazy" src='/medtrack/pic5.jpeg' className="rounded-2xl w-[32rem] h-[20rem]" alt="Gaya Pharmacy Services"></img>
        ...
        {/* Location 3 */}
        <div className="md:max-w-[30%] space-y-2">
            <img loading="lazy" src='/medtrack/pic6.jpeg' className="rounded-2xl w-[32rem] h-[20rem]" alt="Nalanda Pharmacy Services"></img>
