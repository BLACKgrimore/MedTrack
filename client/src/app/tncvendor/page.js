...
const tnc = () => {
    return (
        <div class="xsm:w-full bg-white shadow-md rounded-lg md:p-8 xsm:p-3 md:pt-20 xsm:pt-20">
            ...
            <div class="w-full bg-white shadow-md rounded-lg space-y-6">
                <div className="">
                    <div class=" bg-white shadow-md rounded-lg p-2">

                        <h1 class="md:text-4xl xsm:text-2xl font-bold text-center text-gray-800 mb-6">Vendors Terms and Conditions - Evego Event</h1>
                        ...
                        <div class="prose">
                            ...
                            <div class="px-3 ">
                                ...
                                <h2 class="text-2xl md:text-3xl font-bold mb-4">1. Acceptance of Terms</h2>
                                ...
                                <h2 class="text-2xl md:text-3xl font-bold mb-4">2. Vendor Listing and Profile Information</h2>
                                <div class="  ">
