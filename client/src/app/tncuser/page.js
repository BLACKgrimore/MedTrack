            ...
            <div class="w-full bg-white shadow-md rounded-lg space-y-6">
                <div className="">
                    <div class="bg-white shadow-md rounded-lg py-3">
                        ...
                        <h1 class="md:text-4xl xsm:text-2xl text-center font-bold text-gray-800 mb-6 ">User Terms and Conditions - Evego Event</h1>

                        <div class="prose">

                            <div class="px-4">
                                {/* <h1 class="text-xl md:text-3xl font-bold mb-6">User Terms and Conditions - Evego Event</h1> */}
